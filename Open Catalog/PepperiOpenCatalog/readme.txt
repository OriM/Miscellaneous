...
Contributors: pepperi
Donate link:
Tags: catalog, products, ecommerce
...
Allows distributors and wholesalers using the Pepperi B2B eCommerce module to share their product catalog with potential customers as an open catalog with no login required.
...
<head>
  ...
  <title>Pepperi Open Catalog Plugin</title>
  <link rel="stylesheet" href="https://stackedit.io/style.css" />
</head>

<body class="stackedit">
  <div class="stackedit__html"><p><strong>Pepperi is an omnichannel B2B sales platform for brands and wholesale distributors.</strong></p>
<p>Pepperi connects <a href="https://www.pepperi.com/sales-force-automation-2/">Sales Force Automation</a> with <a href="https://www.pepperi.com/b2b-e-commerce/">B2B eCommerce</a> on an enterprise-grade cloud platform, so you can sell bigger, smarter and faster, and easily adapt to market dynamics.</p>
...
<p>To learn more about Pepperi go to <a href="https://www.pepperi.com">https://www.pepperi.com</a></p>
<p>Contact us at <a href="https://www.pepperi.com/contact-sales">https://www.pepperi.com/contact-sales</a></p>
</div>
</body>
...
= Do I need to be a Pepperi customer to use this plugin? =

Yes. The Plugin is meant for existing Pepperi customers using the Pepperi B2B eCommerce module who want to extend their catalog beyond their existing customers.

= How much does the Plugin cost? =

The plugin is an add-on to the Pepperi B2B eCommerce module and pricing will be provided directly by your Pepperi sales representative.

== Screenshots ==

1. Pepperi Open Catalog allows to add a top bar with your categories dropdown and search box
2. Categories dropdown displays the entire category tree
3. Pepperi Open Catalog Products, along with the categories top bar and breadcrumbs
4. Pepperi Open Catalog Product information page 
